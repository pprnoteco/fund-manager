...
(function(App){
    ...
    var Modal = App.Modal;
    var UpdateForm = <?= $modelClass ?>.UpdateForm;
    ...
    var UpdateModal = Modal.extend({
        ...
        alertElement: '<?= $slug ?>-update-modal-alert',
        ...
        initForm: function () {
            var form = new UpdateForm({
                el: document.getElementById('<?= $slug ?>-update-form')
            });
            this.form = form;
        },
    ...
    App.<?= $modelClass ?>.UpdateModal = UpdateModal;
