...
(function(App){
    ...
    var Modal = App.Modal;
    var CreateForm = <?= $modelClass ?>.CreateForm;
    ...
    var CreateModal = Modal.extend({
        ...
        alertElement: '<?= $slug ?>-create-modal-alert',
        ...
        initForm: function () {
            var form = new CreateForm({
                el: document.getElementById('<?= $slug ?>-create-form')
            });
            this.form = form;
        },
    ...
    App.<?= $modelClass ?>.CreateModal = CreateModal;
