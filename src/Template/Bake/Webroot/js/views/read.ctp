...
(function(App){
    ...
    var ReadView = View.extend({
        ...
        initComments: function () {
            ...
            var panel = new Panel({
                parent: '<%= $modelClass %>',
                parentId: model.id,
                el: document.getElementById('<%= $slug %>-comments-panel'),
                collection: comments
            });
        ...
        initAttachments: function () {
            ...
            var panel = new Panel({
                parent: '<%= $modelClass %>',
                parentId: model.id,
                el: document.getElementById('<%= $slug %>-attachments-panel'),
    ...
    App.<%= $modelClass %>.views.Read = ReadView;
