...
<div class="row">
    ...
    <div class="col-sm-9">
        ...
        <?= $this->element('table/pagination', [ 'slug' => 'transactions' ]) ?>
    ...
    <div class="col-sm-3">
        ...
        <div class="list-group table-toolbar" id="transactions-table-toolbar">
        ...
        <div class="list-group">
            ...
            <a class="list-group-item list-group-item-action" 
               href="<?= $this->url('/transactions/import') ?>">
                <span class="fa fa-upload fa-fw"></span>
                Import
            </a>
            
            <a class="list-group-item list-group-item-action" 
               href="<?= $this->url('/transactions/export') ?>">
...
(function(){
    ...
    var View = App.Transactions.views.Index;
