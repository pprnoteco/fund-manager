...
<div class="row">
    ...
    <div class="col-sm-9">
        ...
        <?= $this->element('table/pagination', [ 'slug' => 'offerings' ]) ?>
    ...
    <div class="col-sm-3">
        ...
        <?= $this->element('table/searchbox', [ 'slug' => 'offerings' ]) ?>
        
        <!-- Navigation
        ----------------------------------------------------------------->
        
        <div class="list-group table-toolbar" id="offerings-table-toolbar">
        ...
        <div class="list-group">
            ...
            <a class="list-group-item list-group-item-action" 
               href="<?= $this->url('/offerings/import') ?>">
                <span class="fa fa-upload fa-fw"></span>
                Import
            </a>
            
            <a class="list-group-item list-group-item-action" 
               href="<?= $this->url('/offerings/export') ?>">
...
(function(){
    ...
    var View = App.Offerings.views.Index;
