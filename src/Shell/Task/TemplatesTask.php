 ...
 *
 */
class TemplatesTask extends BakeTask
{
    /**
     ...
     * @var array
     */
    public $noTemplateActions = ['delete', 'read'];
    ...
    public function main($name = null, $template = null, $action = null)
    {
        ...
        foreach ($methods as $method) {
            if (in_array($method, $complete)) continue;
    ...
    protected function _loadController()
    {
        ...
        // CUSTOM --------------------------------------------------------
        $underscore = Inflector::underscore($this->controllerName);
        $slug = strtolower(Inflector::slug($underscore, '-'));
        $columns = [];
